...
function ProductDetails() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 sm:p-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      {/* Product Image */}
      <img
        src={product.image}
        alt={product.title}
      ...
      <div>
        ...
        <p className="text-gray-700 mb-6">
          This luxurious product is designed to enhance your natural beauty with
          nourishing ingredients and stunning results.
        </p>
